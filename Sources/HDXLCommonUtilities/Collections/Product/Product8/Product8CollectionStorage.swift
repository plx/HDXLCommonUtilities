//
//  Product8CollectionStorage.swift
//

import Foundation

// -------------------------------------------------------------------------- //
// MARK: Product8CollectionStorage - Definition
// -------------------------------------------------------------------------- //

@usableFromInline
internal final class Product8CollectionStorage<A,B,C,D,E,F,G,H,Position,Element>
  where
  A:Collection,
  B:Collection,
  C:Collection,
  ...
  @usableFromInline
  internal typealias Index = Product8CollectionIndex<Position>
...
// -------------------------------------------------------------------------- //
// MARK: Product8CollectionStorage - Conveniences
// -------------------------------------------------------------------------- //
...
internal extension Product8CollectionStorage {
  ...
  var constituentCounts: UniformInlineProduct8<Int> {
    get {
      return UniformInlineProduct8<Int>(
        self.$a.count,
        self.$b.count,
        self.$c.count,
        self.$d.count,
...
// -------------------------------------------------------------------------- //
// MARK: Product8CollectionStorage - Reflection Support
// -------------------------------------------------------------------------- //
...
internal extension Product8CollectionStorage {
  ...
  static var shortTypeName: String {
    get {
      return "Product8CollectionStorage"
    }
  }
...
// -------------------------------------------------------------------------- //
// MARK: Product8CollectionStorage - Position Retreat Support
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: Product8CollectionStorage - Distance Calculation
// -------------------------------------------------------------------------- //

internal extension Product8CollectionStorage {
  
  @usableFromInline
  typealias DistancesFromStarts = UniformInlineProduct8<Int>
...
// -------------------------------------------------------------------------- //
// MARK: Product8CollectionStorage - With Derivation
// -------------------------------------------------------------------------- //
...
internal extension Product8CollectionStorage {
  ...
  @inlinable
  func with(a: A) -> Product8CollectionStorage<A,B,C,D,E,F,G,H,Position,Element> {
    return Product8CollectionStorage<A,B,C,D,E,F,G,H,Position,Element>(
      a,
      b,
      c,
      d,
  ...
  @inlinable
  func with(b: B) -> Product8CollectionStorage<A,B,C,D,E,F,G,H,Position,Element> {
    return Product8CollectionStorage<A,B,C,D,E,F,G,H,Position,Element>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(c: C) -> Product8CollectionStorage<A,B,C,D,E,F,G,H,Position,Element> {
    return Product8CollectionStorage<A,B,C,D,E,F,G,H,Position,Element>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(d: D) -> Product8CollectionStorage<A,B,C,D,E,F,G,H,Position,Element> {
    return Product8CollectionStorage<A,B,C,D,E,F,G,H,Position,Element>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(e: E) -> Product8CollectionStorage<A,B,C,D,E,F,G,H,Position,Element> {
    return Product8CollectionStorage<A,B,C,D,E,F,G,H,Position,Element>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(f: F) -> Product8CollectionStorage<A,B,C,D,E,F,G,H,Position,Element> {
    return Product8CollectionStorage<A,B,C,D,E,F,G,H,Position,Element>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(g: G) -> Product8CollectionStorage<A,B,C,D,E,F,G,H,Position,Element> {
    return Product8CollectionStorage<A,B,C,D,E,F,G,H,Position,Element>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(h: H) -> Product8CollectionStorage<A,B,C,D,E,F,G,H,Position,Element> {
    return Product8CollectionStorage<A,B,C,D,E,F,G,H,Position,Element>(
      a,
      b,
      c,
...
// -------------------------------------------------------------------------- //
// MARK: Product8CollectionStorage - Validatable
// -------------------------------------------------------------------------- //

extension Product8CollectionStorage : Validatable {
...
// -------------------------------------------------------------------------- //
// MARK: Product8CollectionStorage - Equatable
// -------------------------------------------------------------------------- //

extension Product8CollectionStorage : Equatable
  where
  A:Equatable,
  B:Equatable,
  C:Equatable,
  ...
  internal static func ==(
    lhs: Product8CollectionStorage<A,B,C,D,E,F,G,H,Position,Element>,
    rhs: Product8CollectionStorage<A,B,C,D,E,F,G,H,Position,Element>) -> Bool {
    // /////////////////////////////////////////////////////////////////////////
...
// -------------------------------------------------------------------------- //
// MARK: Product8CollectionStorage - Hashable
// -------------------------------------------------------------------------- //

extension Product8CollectionStorage : Hashable
  where
  A:Hashable,
  B:Hashable,
  C:Hashable,
...
// -------------------------------------------------------------------------- //
// MARK: Product8CollectionStorage - CustomStringConvertible
// -------------------------------------------------------------------------- //

extension Product8CollectionStorage : CustomStringConvertible {
...
// -------------------------------------------------------------------------- //
// MARK: Product8CollectionStorage - CustomDebugStringConvertible
// -------------------------------------------------------------------------- //

extension Product8CollectionStorage : CustomDebugStringConvertible {
...
// -------------------------------------------------------------------------- //
// MARK: Product8CollectionStorage - Codable
// -------------------------------------------------------------------------- //

extension Product8CollectionStorage : Codable
  where
  A:Codable,
  B:Codable,
  C:Codable,
