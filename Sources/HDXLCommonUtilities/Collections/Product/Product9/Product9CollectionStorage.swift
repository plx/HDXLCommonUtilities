//
//  Product9CollectionStorage.swift
//

import Foundation

// -------------------------------------------------------------------------- //
// MARK: Product9CollectionStorage - Definition
// -------------------------------------------------------------------------- //

@usableFromInline
internal final class Product9CollectionStorage<A,B,C,D,E,F,G,H,I,Position,Element>
  where
  A:Collection,
  B:Collection,
  C:Collection,
  ...
  @usableFromInline
  internal typealias Index = Product9CollectionIndex<Position>
...
// -------------------------------------------------------------------------- //
// MARK: Product9CollectionStorage - Conveniences
// -------------------------------------------------------------------------- //

internal extension Product9CollectionStorage {
...
// -------------------------------------------------------------------------- //
// MARK: Product9CollectionStorage - Reflection Support
// -------------------------------------------------------------------------- //
...
internal extension Product9CollectionStorage {
  ...
  static var shortTypeName: String {
    get {
      return "Product9CollectionStorage"
    }
  }
...
// -------------------------------------------------------------------------- //
// MARK: Product9CollectionStorage - Position Retreat Support
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: Product9CollectionStorage - Distance Calculation
// -------------------------------------------------------------------------- //

internal extension Product9CollectionStorage {
  
  @usableFromInline
  typealias DistancesFromStarts = UniformInlineProduct9<Int>
...
// -------------------------------------------------------------------------- //
// MARK: Product9CollectionStorage - With Derivation
// -------------------------------------------------------------------------- //
...
internal extension Product9CollectionStorage {
  ...
  @inlinable
  func with(a: A) -> Product9CollectionStorage<A,B,C,D,E,F,G,H,I,Position,Element> {
    return Product9CollectionStorage<A,B,C,D,E,F,G,H,I,Position,Element>(
      a,
      b,
      c,
      d,
  ...
  @inlinable
  func with(b: B) -> Product9CollectionStorage<A,B,C,D,E,F,G,H,I,Position,Element> {
    return Product9CollectionStorage<A,B,C,D,E,F,G,H,I,Position,Element>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(c: C) -> Product9CollectionStorage<A,B,C,D,E,F,G,H,I,Position,Element> {
    return Product9CollectionStorage<A,B,C,D,E,F,G,H,I,Position,Element>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(d: D) -> Product9CollectionStorage<A,B,C,D,E,F,G,H,I,Position,Element> {
    return Product9CollectionStorage<A,B,C,D,E,F,G,H,I,Position,Element>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(e: E) -> Product9CollectionStorage<A,B,C,D,E,F,G,H,I,Position,Element> {
    return Product9CollectionStorage<A,B,C,D,E,F,G,H,I,Position,Element>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(f: F) -> Product9CollectionStorage<A,B,C,D,E,F,G,H,I,Position,Element> {
    return Product9CollectionStorage<A,B,C,D,E,F,G,H,I,Position,Element>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(g: G) -> Product9CollectionStorage<A,B,C,D,E,F,G,H,I,Position,Element> {
    return Product9CollectionStorage<A,B,C,D,E,F,G,H,I,Position,Element>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(h: H) -> Product9CollectionStorage<A,B,C,D,E,F,G,H,I,Position,Element> {
    return Product9CollectionStorage<A,B,C,D,E,F,G,H,I,Position,Element>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(i: I) -> Product9CollectionStorage<A,B,C,D,E,F,G,H,I,Position,Element> {
    return Product9CollectionStorage<A,B,C,D,E,F,G,H,I,Position,Element>(
      a,
      b,
      c,
...
// -------------------------------------------------------------------------- //
// MARK: Product9CollectionStorage - Validatable
// -------------------------------------------------------------------------- //

extension Product9CollectionStorage : Validatable {
...
// -------------------------------------------------------------------------- //
// MARK: Product9CollectionStorage - Equatable
// -------------------------------------------------------------------------- //

extension Product9CollectionStorage : Equatable
  where
  A:Equatable,
  B:Equatable,
  C:Equatable,
  ...
  internal static func ==(
    lhs: Product9CollectionStorage<A,B,C,D,E,F,G,H,I,Position,Element>,
    rhs: Product9CollectionStorage<A,B,C,D,E,F,G,H,I,Position,Element>) -> Bool {
    // /////////////////////////////////////////////////////////////////////////
...
// -------------------------------------------------------------------------- //
// MARK: Product9CollectionStorage - Hashable
// -------------------------------------------------------------------------- //

extension Product9CollectionStorage : Hashable
  where
  A:Hashable,
  B:Hashable,
  C:Hashable,
...
// -------------------------------------------------------------------------- //
// MARK: Product9CollectionStorage - CustomStringConvertible
// -------------------------------------------------------------------------- //

extension Product9CollectionStorage : CustomStringConvertible {
...
// -------------------------------------------------------------------------- //
// MARK: Product9CollectionStorage - CustomDebugStringConvertible
// -------------------------------------------------------------------------- //

extension Product9CollectionStorage : CustomDebugStringConvertible {
...
// -------------------------------------------------------------------------- //
// MARK: Product9CollectionStorage - Codable
// -------------------------------------------------------------------------- //

extension Product9CollectionStorage : Codable
  where
  A:Codable,
  B:Codable,
  C:Codable,
