//
//  InlineProduct9CollectionStorage.swift
//

import Foundation

// -------------------------------------------------------------------------- //
// MARK: InlineProduct9CollectionStorage - Definition
// -------------------------------------------------------------------------- //

@usableFromInline
internal final class InlineProduct9CollectionStorage<
  A:Collection,
  B:Collection,
  C:Collection,
  D:Collection,
  ...
  @usableFromInline
  internal typealias Index = InlineProduct9CollectionIndex<A,B,C,D,E,F,G,H,I>
  ...
  @usableFromInline
  internal typealias Element = InlineProduct9<
    A.Element,
    B.Element,
    C.Element,
    D.Element,
...
// -------------------------------------------------------------------------- //
// MARK: InlineProduct9CollectionStorage - Conveniences
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: InlineProduct9CollectionStorage - Reflection Support
// -------------------------------------------------------------------------- //
...
internal extension InlineProduct9CollectionStorage {
  ...
  static var shortTypeName: String {
    get {
      return "InlineProduct9CollectionStorage"
    }
  }
...
// -------------------------------------------------------------------------- //
// MARK: InlineProduct9CollectionStorage - Position Retreat Support
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: InlineProduct9CollectionStorage - Distance Calculation
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: InlineProduct9CollectionStorage - With Derivation
// -------------------------------------------------------------------------- //
...
internal extension InlineProduct9CollectionStorage {
  ...
  @usableFromInline
  func with(a: A) -> InlineProduct9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return InlineProduct9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
      d,
  ...
  @inlinable
  func with(b: B) -> InlineProduct9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return InlineProduct9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(c: C) -> InlineProduct9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return InlineProduct9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(d: D) -> InlineProduct9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return InlineProduct9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(e: E) -> InlineProduct9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return InlineProduct9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(f: F) -> InlineProduct9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return InlineProduct9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(g: G) -> InlineProduct9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return InlineProduct9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(h: H) -> InlineProduct9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return InlineProduct9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(i: I) -> InlineProduct9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return InlineProduct9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
...
// -------------------------------------------------------------------------- //
// MARK: InlineProduct9CollectionStorage - Validatable
// -------------------------------------------------------------------------- //

extension InlineProduct9CollectionStorage : Validatable {
...
// -------------------------------------------------------------------------- //
// MARK: InlineProduct9CollectionStorage - Equatable
// -------------------------------------------------------------------------- //

extension InlineProduct9CollectionStorage : Equatable
  where
  A:Equatable,
  B:Equatable,
  C:Equatable,
...
I:Equatable {
  ...
  internal static func ==(
    lhs: InlineProduct9CollectionStorage<A,B,C,D,E,F,G,H,I>,
    rhs: InlineProduct9CollectionStorage<A,B,C,D,E,F,G,H,I>) -> Bool {
    // /////////////////////////////////////////////////////////////////////////
...
// -------------------------------------------------------------------------- //
// MARK: InlineProduct9CollectionStorage - Hashable
// -------------------------------------------------------------------------- //

extension InlineProduct9CollectionStorage : Hashable
  where
  A:Hashable,
  B:Hashable,
  C:Hashable,
...
// -------------------------------------------------------------------------- //
// MARK: InlineProduct9CollectionStorage - CustomStringConvertible
// -------------------------------------------------------------------------- //

extension InlineProduct9CollectionStorage : CustomStringConvertible {
...
// -------------------------------------------------------------------------- //
// MARK: InlineProduct9CollectionStorage - CustomDebugStringConvertible
// -------------------------------------------------------------------------- //

extension InlineProduct9CollectionStorage : CustomDebugStringConvertible {
...
// -------------------------------------------------------------------------- //
// MARK: InlineProduct9CollectionStorage - Codable
// -------------------------------------------------------------------------- //

extension InlineProduct9CollectionStorage : Codable
  where
  A:Codable,
  B:Codable,
  C:Codable,
