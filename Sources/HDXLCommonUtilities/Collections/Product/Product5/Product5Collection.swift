//
//  Product5Collection.swift
//

import Foundation

// -------------------------------------------------------------------------- //
// MARK: Product5Collection - Definition
// -------------------------------------------------------------------------- //
...
public struct Product5Collection<A,B,C,D,E,Position,Element>
where
  A:Collection,
  B:Collection,
  C:Collection,
  ...
  @usableFromInline
  internal typealias Storage = Product5CollectionStorage<A,B,C,D,E,Position,Element>
...
// -------------------------------------------------------------------------- //
// MARK: Product5Collection - Cache Support
// -------------------------------------------------------------------------- //

internal extension Product5Collection {
...
// -------------------------------------------------------------------------- //
// MARK: Product5Collection - Conveniences
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: Product5Collection - With Derivation
// -------------------------------------------------------------------------- //

public extension Product5Collection {
  
  @inlinable
  func with(a: A) -> Product5Collection<A,B,C,D,E,Position,Element> {
  ...
  @inlinable
  func with(b: B) -> Product5Collection<A,B,C,D,E,Position,Element> {
    return Product5Collection<A,B,C,D,E,Position,Element>(
      storage: self.storage.with(
        b: b
      )
  ...
  @inlinable
  func with(c: C) -> Product5Collection<A,B,C,D,E,Position,Element> {
    return Product5Collection<A,B,C,D,E,Position,Element>(
      storage: self.storage.with(
        c: c
      )
  ...
  @inlinable
  func with(d: D) -> Product5Collection<A,B,C,D,E,Position,Element> {
    return Product5Collection<A,B,C,D,E,Position,Element>(
      storage: self.storage.with(
        d: d
      )
  ...
  @inlinable
  func with(e: E) -> Product5Collection<A,B,C,D,E,Position,Element> {
    return Product5Collection<A,B,C,D,E,Position,Element>(
      storage: self.storage.with(
        e: e
      )
...
// -------------------------------------------------------------------------- //
// MARK: Product5Collection - Property Exposure
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: Product5Collection - Validatable
// -------------------------------------------------------------------------- //

extension Product5Collection : Validatable {
...
// -------------------------------------------------------------------------- //
// MARK: Product5Collection - Equatable
// -------------------------------------------------------------------------- //

extension Product5Collection : Equatable
  where
  A:Equatable,
  B:Equatable,
  C:Equatable,
  ...
  @inlinable
  public static func ==(
    lhs: Product5Collection<A,B,C,D,E,Position,Element>,
    rhs: Product5Collection<A,B,C,D,E,Position,Element>) -> Bool {
    // /////////////////////////////////////////////////////////////////////////
...
// -------------------------------------------------------------------------- //
// MARK: Product5Collection - Hashable
// -------------------------------------------------------------------------- //

extension Product5Collection : Hashable
  where
  A:Hashable,
  B:Hashable,
  C:Hashable,
...
// -------------------------------------------------------------------------- //
// MARK: Product5Collection - Codable
// -------------------------------------------------------------------------- //

extension Product5Collection : Codable
  where
  A:Codable,
  B:Codable,
  C:Codable,
...
// -------------------------------------------------------------------------- //
// MARK: Product5Collection - Collection
// -------------------------------------------------------------------------- //

extension Product5Collection : Collection {

  public typealias Index = Product5CollectionIndex<Position>
  
//  public typealias Indices = Product5CollectionIndices<
//    A,
//    B,
//    C,
//    D,
...
//  public typealias SubSequence = Product5Collection<
//    A.SubSequence,
//    B.SubSequence,
//    C.SubSequence,
//    D.SubSequence,
...
// -------------------------------------------------------------------------- //
// MARK: Product5Collection - BidirectionalCollection
// -------------------------------------------------------------------------- //

extension Product5Collection : BidirectionalCollection
  where
...
// -------------------------------------------------------------------------- //
// MARK: Product5Collection - RandomAccessCollection
// -------------------------------------------------------------------------- //

extension Product5Collection : RandomAccessCollection
  where
