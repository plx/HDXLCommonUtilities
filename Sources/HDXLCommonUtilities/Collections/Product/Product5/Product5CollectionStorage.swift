//
//  Product5CollectionStorage.swift
//

import Foundation

// -------------------------------------------------------------------------- //
// MARK: Product5CollectionStorage - Definition
// -------------------------------------------------------------------------- //

@usableFromInline
internal final class Product5CollectionStorage<A,B,C,D,E,Position,Element>
  where
  A:Collection,
  B:Collection,
  C:Collection,
  ...
  @usableFromInline
  internal typealias Index = Product5CollectionIndex<Position>
...
// -------------------------------------------------------------------------- //
// MARK: Product5CollectionStorage - Conveniences
// -------------------------------------------------------------------------- //
...
internal extension Product5CollectionStorage {
  ...
  @usableFromInline
  var constituentCounts: UniformInlineProduct5<Int> {
    get {
      return UniformInlineProduct5<Int>(
        self.$a.count,
        self.$b.count,
        self.$c.count,
        self.$d.count,
...
// -------------------------------------------------------------------------- //
// MARK: Product5CollectionStorage - Reflection Support
// -------------------------------------------------------------------------- //
...
internal extension Product5CollectionStorage {
  ...
  static var shortTypeName: String {
    get {
      return "Product5CollectionStorage"
    }
  }
...
// -------------------------------------------------------------------------- //
// MARK: Product5CollectionStorage - Position Retreat Support
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: Product5CollectionStorage - Distance Calculation
// -------------------------------------------------------------------------- //

internal extension Product5CollectionStorage {
  
  @usableFromInline
  typealias DistancesFromStarts = UniformInlineProduct5<Int>
...
// -------------------------------------------------------------------------- //
// MARK: Product5CollectionStorage - With Derivation
// -------------------------------------------------------------------------- //
...
internal extension Product5CollectionStorage {
  ...
  @inlinable
  func with(a: A) -> Product5CollectionStorage<A,B,C,D,E,Position,Element> {
    return Product5CollectionStorage<A,B,C,D,E,Position,Element>(
      a,
      b,
      c,
      d,
  ...
  @inlinable
  func with(b: B) -> Product5CollectionStorage<A,B,C,D,E,Position,Element> {
    return Product5CollectionStorage<A,B,C,D,E,Position,Element>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(c: C) -> Product5CollectionStorage<A,B,C,D,E,Position,Element> {
    return Product5CollectionStorage<A,B,C,D,E,Position,Element>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(d: D) -> Product5CollectionStorage<A,B,C,D,E,Position,Element> {
    return Product5CollectionStorage<A,B,C,D,E,Position,Element>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(e: E) -> Product5CollectionStorage<A,B,C,D,E,Position,Element> {
    return Product5CollectionStorage<A,B,C,D,E,Position,Element>(
      a,
      b,
      c,
...
// -------------------------------------------------------------------------- //
// MARK: Product5CollectionStorage - Validatable
// -------------------------------------------------------------------------- //

extension Product5CollectionStorage : Validatable {
...
// -------------------------------------------------------------------------- //
// MARK: Product5CollectionStorage - Equatable
// -------------------------------------------------------------------------- //

extension Product5CollectionStorage : Equatable
  where
  A:Equatable,
  B:Equatable,
  C:Equatable,
  ...
  internal static func ==(
    lhs: Product5CollectionStorage<A,B,C,D,E,Position,Element>,
    rhs: Product5CollectionStorage<A,B,C,D,E,Position,Element>) -> Bool {
    // /////////////////////////////////////////////////////////////////////////
...
// -------------------------------------------------------------------------- //
// MARK: Product5CollectionStorage - Hashable
// -------------------------------------------------------------------------- //

extension Product5CollectionStorage : Hashable
  where
  A:Hashable,
  B:Hashable,
  C:Hashable,
...
// -------------------------------------------------------------------------- //
// MARK: Product5CollectionStorage - CustomStringConvertible
// -------------------------------------------------------------------------- //

extension Product5CollectionStorage : CustomStringConvertible {
...
// -------------------------------------------------------------------------- //
// MARK: Product5CollectionStorage - CustomDebugStringConvertible
// -------------------------------------------------------------------------- //

extension Product5CollectionStorage : CustomDebugStringConvertible {
...
// -------------------------------------------------------------------------- //
// MARK: Product5CollectionStorage - Codable
// -------------------------------------------------------------------------- //

extension Product5CollectionStorage : Codable
  where
  A:Codable,
  B:Codable,
  C:Codable,
  ...
  @usableFromInline
  internal typealias CodingKeys = Arity5ProductCodingKeys
