//
//  SumChain6CollectionStorage.swift
//

import Foundation

// -------------------------------------------------------------------------- //
// MARK: SumChain6CollectionStorage - Definition
// -------------------------------------------------------------------------- //

@usableFromInline
internal final class SumChain6CollectionStorage<
  A:Collection,
  B:Collection,
  C:Collection,
  D:Collection,
  ...
  @usableFromInline
  internal typealias Index = SumChain6CollectionIndex<A,B,C,D,E,F>
  ...
  @usableFromInline
  internal typealias Element = Sum6<
    A.Element,
    B.Element,
    C.Element,
    D.Element,
...
// -------------------------------------------------------------------------- //
// MARK: SumChain6CollectionStorage - Reflection Support
// -------------------------------------------------------------------------- //
...
internal extension SumChain6CollectionStorage {
  ...
  static var shortTypeName: String {
    get {
      return "SumChain6CollectionStorage"
    }
  }
...
// -------------------------------------------------------------------------- //
// MARK: SumChain6CollectionStorage - Position Advancement Support
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: SumChain6CollectionStorage - Position Linearization Support
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: SumChain6CollectionStorage - Position Retreat
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: SumChain6CollectionStorage - Position Retreat Support
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: SumChain6CollectionStorage - With Derivation
// -------------------------------------------------------------------------- //
...
internal extension SumChain6CollectionStorage {
  ...
  @inlinable
  func with(a: A) -> SumChain6CollectionStorage<A,B,C,D,E,F> {
    return SumChain6CollectionStorage<A,B,C,D,E,F>(
      a,
      b,
      c,
      d,
  ...
  @inlinable
  func with(b: B) -> SumChain6CollectionStorage<A,B,C,D,E,F> {
    return SumChain6CollectionStorage<A,B,C,D,E,F>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(c: C) -> SumChain6CollectionStorage<A,B,C,D,E,F> {
    return SumChain6CollectionStorage<A,B,C,D,E,F>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(d: D) -> SumChain6CollectionStorage<A,B,C,D,E,F> {
    return SumChain6CollectionStorage<A,B,C,D,E,F>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(e: E) -> SumChain6CollectionStorage<A,B,C,D,E,F> {
    return SumChain6CollectionStorage<A,B,C,D,E,F>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(f: F) -> SumChain6CollectionStorage<A,B,C,D,E,F> {
    return SumChain6CollectionStorage<A,B,C,D,E,F>(
      a,
      b,
      c,
...
// -------------------------------------------------------------------------- //
// MARK: SumChain6CollectionStorage - Validatable
// -------------------------------------------------------------------------- //

extension SumChain6CollectionStorage : Validatable {
...
// -------------------------------------------------------------------------- //
// MARK: SumChain6CollectionStorage - Equatable
// -------------------------------------------------------------------------- //

extension SumChain6CollectionStorage : Equatable
  where
  A:Equatable,
  B:Equatable,
  C:Equatable,
  ...
  internal static func ==(
    lhs: SumChain6CollectionStorage<A,B,C,D,E,F>,
    rhs: SumChain6CollectionStorage<A,B,C,D,E,F>) -> Bool {
    // /////////////////////////////////////////////////////////////////////////
...
// -------------------------------------------------------------------------- //
// MARK: SumChain6CollectionStorage - Hashable
// -------------------------------------------------------------------------- //

extension SumChain6CollectionStorage : Hashable
  where
  A:Hashable,
  B:Hashable,
  C:Hashable,
...
// -------------------------------------------------------------------------- //
// MARK: SumChain6CollectionStorage - CustomStringConvertible
// -------------------------------------------------------------------------- //

extension SumChain6CollectionStorage : CustomStringConvertible {
...
// -------------------------------------------------------------------------- //
// MARK: SumChain6CollectionStorage - CustomDebugStringConvertible
// -------------------------------------------------------------------------- //

extension SumChain6CollectionStorage : CustomDebugStringConvertible {
...
// -------------------------------------------------------------------------- //
// MARK: SumChain6CollectionStorage - Codable
// -------------------------------------------------------------------------- //

extension SumChain6CollectionStorage : Codable
  where
  A:Codable,
  B:Codable,
  C:Codable,
