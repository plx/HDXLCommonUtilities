//
//  SumChain8CollectionStorage.swift
//

import Foundation

// -------------------------------------------------------------------------- //
// MARK: SumChain8CollectionStorage - Definition
// -------------------------------------------------------------------------- //

@usableFromInline
internal final class SumChain8CollectionStorage<
  A:Collection,
  B:Collection,
  C:Collection,
  D:Collection,
  ...
  @usableFromInline
  internal typealias Index = SumChain8CollectionIndex<A,B,C,D,E,F,G,H>
  ...
  @usableFromInline
  internal typealias Element = Sum8<
    A.Element,
    B.Element,
    C.Element,
    D.Element,
...
// -------------------------------------------------------------------------- //
// MARK: SumChain8CollectionStorage - Reflection Support
// -------------------------------------------------------------------------- //
...
internal extension SumChain8CollectionStorage {
  ...
  static var shortTypeName: String {
    get {
      return "SumChain8CollectionStorage"
    }
  }
...
// -------------------------------------------------------------------------- //
// MARK: SumChain8CollectionStorage - Position Advancement Support
// -------------------------------------------------------------------------- //
...
internal extension SumChain8CollectionStorage {
  ...
  @inlinable
  func firstPosition(after position: Arity8Position) -> Position? {
    switch position {
    case .a:
...
// -------------------------------------------------------------------------- //
// MARK: SumChain8CollectionStorage - Position Linearization Support
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: SumChain8CollectionStorage - Position Retreat
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: SumChain8CollectionStorage - Position Retreat Support
// -------------------------------------------------------------------------- //
...
internal extension SumChain8CollectionStorage {
  ...
  @inlinable
  func finalPosition(before position: Arity8Position) -> Position? {
    switch position {
    case .a:
      return self.finalPositionBeforeA()
    case .b:
...
// -------------------------------------------------------------------------- //
// MARK: SumChain8CollectionStorage - With Derivation
// -------------------------------------------------------------------------- //
...
internal extension SumChain8CollectionStorage {
  ...
  @inlinable
  func with(a: A) -> SumChain8CollectionStorage<A,B,C,D,E,F,G,H> {
    return SumChain8CollectionStorage<A,B,C,D,E,F,G,H>(
      a,
      b,
      c,
      d,
  ...
  @inlinable
  func with(b: B) -> SumChain8CollectionStorage<A,B,C,D,E,F,G,H> {
    return SumChain8CollectionStorage<A,B,C,D,E,F,G,H>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(c: C) -> SumChain8CollectionStorage<A,B,C,D,E,F,G,H> {
    return SumChain8CollectionStorage<A,B,C,D,E,F,G,H>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(d: D) -> SumChain8CollectionStorage<A,B,C,D,E,F,G,H> {
    return SumChain8CollectionStorage<A,B,C,D,E,F,G,H>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(e: E) -> SumChain8CollectionStorage<A,B,C,D,E,F,G,H> {
    return SumChain8CollectionStorage<A,B,C,D,E,F,G,H>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(f: F) -> SumChain8CollectionStorage<A,B,C,D,E,F,G,H> {
    return SumChain8CollectionStorage<A,B,C,D,E,F,G,H>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(g: G) -> SumChain8CollectionStorage<A,B,C,D,E,F,G,H> {
    return SumChain8CollectionStorage<A,B,C,D,E,F,G,H>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(h: H) -> SumChain8CollectionStorage<A,B,C,D,E,F,G,H> {
    return SumChain8CollectionStorage<A,B,C,D,E,F,G,H>(
      a,
      b,
      c,
...
// -------------------------------------------------------------------------- //
// MARK: SumChain8CollectionStorage - Validatable
// -------------------------------------------------------------------------- //

extension SumChain8CollectionStorage : Validatable {
...
// -------------------------------------------------------------------------- //
// MARK: SumChain8CollectionStorage - Equatable
// -------------------------------------------------------------------------- //

extension SumChain8CollectionStorage : Equatable
  where
  A:Equatable,
  B:Equatable,
  C:Equatable,
  ...
  internal static func ==(
    lhs: SumChain8CollectionStorage<A,B,C,D,E,F,G,H>,
    rhs: SumChain8CollectionStorage<A,B,C,D,E,F,G,H>) -> Bool {
    // /////////////////////////////////////////////////////////////////////////
...
// -------------------------------------------------------------------------- //
// MARK: SumChain8CollectionStorage - Hashable
// -------------------------------------------------------------------------- //

extension SumChain8CollectionStorage : Hashable
  where
  A:Hashable,
  B:Hashable,
  C:Hashable,
...
// -------------------------------------------------------------------------- //
// MARK: SumChain8CollectionStorage - CustomStringConvertible
// -------------------------------------------------------------------------- //

extension SumChain8CollectionStorage : CustomStringConvertible {
...
// -------------------------------------------------------------------------- //
// MARK: SumChain8CollectionStorage - CustomDebugStringConvertible
// -------------------------------------------------------------------------- //

extension SumChain8CollectionStorage : CustomDebugStringConvertible {
...
// -------------------------------------------------------------------------- //
// MARK: SumChain8CollectionStorage - Codable
// -------------------------------------------------------------------------- //

extension SumChain8CollectionStorage : Codable
  where
  A:Codable,
  B:Codable,
  C:Codable,
