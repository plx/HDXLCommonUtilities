...
public struct Adjacent9Collection<Source,Position,Element>
  where
  Source:Collection,
...
public extension Adjacent9Collection {
...
// -------------------------------------------------------------------------- //
// MARK: Adjacent9Collection - Validatable
// -------------------------------------------------------------------------- //

extension Adjacent9Collection:Validatable {
...
// -------------------------------------------------------------------------- //
// MARK: Adjacent9Collection - Equatable
// -------------------------------------------------------------------------- //

extension Adjacent9Collection:Equatable where Source:Equatable {
  
  @inlinable
  public static func ==(
    lhs: Adjacent9Collection<Source,Position,Element>,
    rhs: Adjacent9Collection<Source,Position,Element>) -> Bool {
    // /////////////////////////////////////////////////////////////////////////
...
// -------------------------------------------------------------------------- //
// MARK: Adjacent9Collection - Hashable
// -------------------------------------------------------------------------- //

extension Adjacent9Collection:Hashable where Source:Hashable {
...
// -------------------------------------------------------------------------- //
// MARK: Adjacent9Collection - CustomStringConvertible
// -------------------------------------------------------------------------- //

extension Adjacent9Collection : CustomStringConvertible {
...
// -------------------------------------------------------------------------- //
// MARK: Adjacent9Collection - CustomDebugStringConvertible
// -------------------------------------------------------------------------- //

extension Adjacent9Collection : CustomDebugStringConvertible {
  
  @inlinable
  public var debugDescription: String {
    get {
      return "Adjacent9Collection<\(String(reflecting: Source.self)), \(String(reflecting: Position.self)), \(String(reflecting: Element.self))>(source: \(String(reflecting: self.source)))"
    }
  }
...
// -------------------------------------------------------------------------- //
// MARK: Adjacent9Collection - Codable
// -------------------------------------------------------------------------- //

extension Adjacent9Collection : Codable where Source:Codable {
...
extension Adjacent9Collection : Collection {
  
  public typealias Index = Adjacent9CollectionIndex<Position>
...
extension Adjacent9Collection : BidirectionalCollection where Source:BidirectionalCollection {
...
extension Adjacent9Collection : RandomAccessCollection where Source:RandomAccessCollection {
  
}

// -------------------------------------------------------------------------- //
// MARK: Adjacent9Collection - Collection Support
// -------------------------------------------------------------------------- //

internal extension Adjacent9Collection {
  ...
  func position(
    ...
    let i = self.source.index(after: h)
    return Position(
      a,
      b,
      c,
  ...
  func fixupPositionFromFirstValue(_ position: inout Position) {
    ...
    position.i = self.source.index(after: position.h)
  }
    
}

// -------------------------------------------------------------------------- //
// MARK: Adjacent9Collection - BidirectionalCollection Support
// -------------------------------------------------------------------------- //

internal extension Adjacent9Collection where Source:BidirectionalCollection {
