...
// ------------------------------------------------------------------------ //
// MARK: ProductZip5CollectionStorage - Definition
// ------------------------------------------------------------------------ //

@usableFromInline
internal final class ProductZip5CollectionStorage<A,B,C,D,E,Position,Element>
  where
  A:Collection,
  B:Collection,
  C:Collection,
...
// -------------------------------------------------------------------------- //
// MARK: ProductZip5CollectionStorage - Reflection Support
// -------------------------------------------------------------------------- //

internal extension ProductZip5CollectionStorage {
  
  @inlinable
  static var shortTypeName: String {
    get {
      return "ProductZip5CollectionStorage"
    }
  }
...
// -------------------------------------------------------------------------- //
// MARK: ProductZip5CollectionStorage - With Derivation
// -------------------------------------------------------------------------- //
...
internal extension ProductZip5CollectionStorage {
  ...
  @inlinable
  func with(a: A) -> ProductZip5CollectionStorage<A,B,C,D,E,Position,Element> {
    return ProductZip5CollectionStorage<A,B,C,D,E,Position,Element>(
      a,
      b,
      c,
      d,
  ...
  @inlinable
  func with(b: B) -> ProductZip5CollectionStorage<A,B,C,D,E,Position,Element> {
    return ProductZip5CollectionStorage<A,B,C,D,E,Position,Element>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(c: C) -> ProductZip5CollectionStorage<A,B,C,D,E,Position,Element> {
    return ProductZip5CollectionStorage<A,B,C,D,E,Position,Element>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(d: D) -> ProductZip5CollectionStorage<A,B,C,D,E,Position,Element> {
    return ProductZip5CollectionStorage<A,B,C,D,E,Position,Element>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(e: E) -> ProductZip5CollectionStorage<A,B,C,D,E,Position,Element> {
    return ProductZip5CollectionStorage<A,B,C,D,E,Position,Element>(
      a,
      b,
      c,
...
// ------------------------------------------------------------------------ //
// MARK: ProductZip5CollectionStorage - Validatable
// ------------------------------------------------------------------------ //

extension ProductZip5CollectionStorage : Validatable {
...
// ------------------------------------------------------------------------ //
// MARK: ProductZip5CollectionStorage - Equatable
// ------------------------------------------------------------------------ //

extension ProductZip5CollectionStorage : Equatable
  where
  A:Equatable,
  B:Equatable,
  C:Equatable,
  ...
  internal static func ==(
    lhs: ProductZip5CollectionStorage<A,B,C,D,E,Position,Element>,
    rhs: ProductZip5CollectionStorage<A,B,C,D,E,Position,Element>) -> Bool {
    guard lhs !== rhs else {
      return true
    }
    guard
...
// ------------------------------------------------------------------------ //
// MARK: ProductZip5CollectionStorage - Hashable
// ------------------------------------------------------------------------ //

extension ProductZip5CollectionStorage : Hashable
  where
  A:Hashable,
  B:Hashable,
  C:Hashable,
...
// ------------------------------------------------------------------------ //
// MARK: ProductZip5CollectionStorage - CustomStringConvertible
// ------------------------------------------------------------------------ //

extension ProductZip5CollectionStorage : CustomStringConvertible {
...
// ------------------------------------------------------------------------ //
// MARK: ProductZip5CollectionStorage - CustomDebugStringConvertible
// ------------------------------------------------------------------------ //

extension ProductZip5CollectionStorage : CustomDebugStringConvertible {
...
// ------------------------------------------------------------------------ //
// MARK: ProductZip5CollectionStorage - Codable
// ------------------------------------------------------------------------ //

extension ProductZip5CollectionStorage : Codable
  where
  A:Codable,
  B:Codable,
  C:Codable,
...
// ------------------------------------------------------------------------ //
// MARK: ProductZip5CollectionStorage - Collection Support
// ------------------------------------------------------------------------ //

internal extension ProductZip5CollectionStorage {
  
  @usableFromInline
  typealias Index = ProductZip5CollectionIndex<Position>
  ...
  func couldHaveCreated(position: Position) -> Bool {
    guard
      ...
      allArgumentsMutuallyEqual(
        ...
        self.e.distanceFromStart(to: position.e)) else {
          return false
      }
    return true
  }
  ...
  func formPosition(after position: inout Position) -> Bool {
    guard
      ...
      self.e.formSubscriptableIndex(after: &position.e) else {
        return false
    }
    return true
  }
...
internal extension ProductZip5CollectionStorage
  ...
  func formPosition(before position: inout Position) -> Bool {
    guard
      ...
      self.e.formSubscriptableIndex(before: &position.e) else {
        return false
    }
    return true
  }
