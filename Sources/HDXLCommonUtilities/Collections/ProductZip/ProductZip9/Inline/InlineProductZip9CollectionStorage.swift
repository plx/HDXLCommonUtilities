//
//  InlineProductZip9CollectionStorage.swift
//

import Foundation

// ------------------------------------------------------------------------ //
// MARK: InlineProductZip9CollectionStorage - Definition
// ------------------------------------------------------------------------ //

@usableFromInline
internal final class InlineProductZip9CollectionStorage<
  A:Collection,
  B:Collection,
  C:Collection,
  D:Collection,
  ...
  @usableFromInline
  typealias Position = InlineProductZip9CollectionIndex<A,B,C,D,E,F,G,H,I>.Position
  
  @usableFromInline
  typealias Element = InlineProduct9<
    A.Element,
    B.Element,
    C.Element,
    D.Element,
...
// ------------------------------------------------------------------------ //
// MARK: InlineProductZip9CollectionStorage - Retreat Support
// ------------------------------------------------------------------------ //

internal extension InlineProductZip9CollectionStorage
  where
...
// -------------------------------------------------------------------------- //
// MARK: InlineProductZip9CollectionStorage - Reflection Support
// -------------------------------------------------------------------------- //
...
internal extension InlineProductZip9CollectionStorage {
  ...
  static var shortTypeName: String {
    get {
      return "InlineProductZip9CollectionStorage"
    }
  }
...
// -------------------------------------------------------------------------- //
// MARK: InlineProductZip9CollectionStorage - With Derivation
// -------------------------------------------------------------------------- //
...
internal extension InlineProductZip9CollectionStorage {
  ...
  @usableFromInline
  func with(a: A) -> InlineProductZip9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return InlineProductZip9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
      d,
  ...
  @inlinable
  func with(b: B) -> InlineProductZip9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return InlineProductZip9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(c: C) -> InlineProductZip9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return InlineProductZip9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(d: D) -> InlineProductZip9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return InlineProductZip9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(e: E) -> InlineProductZip9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return InlineProductZip9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(f: F) -> InlineProductZip9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return InlineProductZip9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(g: G) -> InlineProductZip9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return InlineProductZip9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(h: H) -> InlineProductZip9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return InlineProductZip9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(i: I) -> InlineProductZip9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return InlineProductZip9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
...
// ------------------------------------------------------------------------ //
// MARK: InlineProductZip9CollectionStorage - Validatable
// ------------------------------------------------------------------------ //

extension InlineProductZip9CollectionStorage : Validatable {
...
// ------------------------------------------------------------------------ //
// MARK: InlineProductZip9CollectionStorage - Equatable
// ------------------------------------------------------------------------ //

extension InlineProductZip9CollectionStorage : Equatable
  where
  A:Equatable,
  B:Equatable,
  C:Equatable,
  ...
  internal static func ==(
    lhs: InlineProductZip9CollectionStorage<A,B,C,D,E,F,G,H,I>,
    rhs: InlineProductZip9CollectionStorage<A,B,C,D,E,F,G,H,I>) -> Bool {
    guard lhs !== rhs else {
      return true
    }
    guard
...
// ------------------------------------------------------------------------ //
// MARK: InlineProductZip9CollectionStorage - Hashable
// ------------------------------------------------------------------------ //

extension InlineProductZip9CollectionStorage : Hashable
  where
  A:Hashable,
  B:Hashable,
  C:Hashable,
...
// ------------------------------------------------------------------------ //
// MARK: InlineProductZip9CollectionStorage - CustomStringConvertible
// ------------------------------------------------------------------------ //

extension InlineProductZip9CollectionStorage : CustomStringConvertible {
...
// ------------------------------------------------------------------------ //
// MARK: InlineProductZip9CollectionStorage - CustomDebugStringConvertible
// ------------------------------------------------------------------------ //

extension InlineProductZip9CollectionStorage : CustomDebugStringConvertible {
...
// ------------------------------------------------------------------------ //
// MARK: InlineProductZip9CollectionStorage - Codable
// ------------------------------------------------------------------------ //

extension InlineProductZip9CollectionStorage : Codable
  where
  A:Codable,
  B:Codable,
  C:Codable,
