...
@usableFromInline
internal final class Chain7CollectionStorage<
  A:Collection,
  B:Collection,
  C:Collection,
  D:Collection,
  ...
  @usableFromInline
  internal typealias Index = Chain7CollectionIndex<A,B,C,D,E,F,G>
...
// -------------------------------------------------------------------------- //
// MARK: Chain7CollectionStorage - Reflection Support
// -------------------------------------------------------------------------- //
...
internal extension Chain7CollectionStorage {
  ...
  static var shortTypeName: String {
    get {
      return "Chain7CollectionStorage"
    }
  }
...
// -------------------------------------------------------------------------- //
// MARK: Chain7CollectionStorage - Position Advancement Support
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: Chain7CollectionStorage - Position Linearization Support
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: Chain7CollectionStorage - Position Retreat
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: Chain7CollectionStorage - Position Retreat Support
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: Chain7CollectionStorage - With Derivation
// -------------------------------------------------------------------------- //
...
internal extension Chain7CollectionStorage {
  ...
  @inlinable
  func with(a: A) -> Chain7CollectionStorage<A,B,C,D,E,F,G> {
    return Chain7CollectionStorage<A,B,C,D,E,F,G>(
      a,
      b,
      c,
      d,
  ...
  @inlinable
  func with(b: B) -> Chain7CollectionStorage<A,B,C,D,E,F,G> {
    return Chain7CollectionStorage<A,B,C,D,E,F,G>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(c: C) -> Chain7CollectionStorage<A,B,C,D,E,F,G> {
    return Chain7CollectionStorage<A,B,C,D,E,F,G>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(d: D) -> Chain7CollectionStorage<A,B,C,D,E,F,G> {
    return Chain7CollectionStorage<A,B,C,D,E,F,G>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(e: E) -> Chain7CollectionStorage<A,B,C,D,E,F,G> {
    return Chain7CollectionStorage<A,B,C,D,E,F,G>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(f: F) -> Chain7CollectionStorage<A,B,C,D,E,F,G> {
    return Chain7CollectionStorage<A,B,C,D,E,F,G>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(g: G) -> Chain7CollectionStorage<A,B,C,D,E,F,G> {
    return Chain7CollectionStorage<A,B,C,D,E,F,G>(
      a,
      b,
      c,
...
// -------------------------------------------------------------------------- //
// MARK: Chain7CollectionStorage - Validatable
// -------------------------------------------------------------------------- //

extension Chain7CollectionStorage : Validatable {
...
// -------------------------------------------------------------------------- //
// MARK: Chain7CollectionStorage - Equatable
// -------------------------------------------------------------------------- //

extension Chain7CollectionStorage : Equatable
  where
  A:Equatable,
  B:Equatable,
  C:Equatable,
  ...
  internal static func ==(
    lhs: Chain7CollectionStorage<A,B,C,D,E,F,G>,
    rhs: Chain7CollectionStorage<A,B,C,D,E,F,G>) -> Bool {
    guard lhs !== rhs else {
      return true
    }
    guard
...
// -------------------------------------------------------------------------- //
// MARK: Chain7CollectionStorage - Hashable
// -------------------------------------------------------------------------- //

extension Chain7CollectionStorage : Hashable
  where
  A:Hashable,
  B:Hashable,
  C:Hashable,
...
// -------------------------------------------------------------------------- //
// MARK: Chain7CollectionStorage - CustomStringConvertible
// -------------------------------------------------------------------------- //

extension Chain7CollectionStorage : CustomStringConvertible {
...
// -------------------------------------------------------------------------- //
// MARK: Chain7CollectionStorage - CustomDebugStringConvertible
// -------------------------------------------------------------------------- //

extension Chain7CollectionStorage : CustomDebugStringConvertible {
...
// -------------------------------------------------------------------------- //
// MARK: Chain7CollectionStorage - Codable
// -------------------------------------------------------------------------- //

extension Chain7CollectionStorage : Codable
  where
  A:Codable,
  B:Codable,
  C:Codable,
