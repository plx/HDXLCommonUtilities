...
@usableFromInline
internal final class Chain9CollectionStorage<
  A:Collection,
  B:Collection,
  C:Collection,
  D:Collection,
  ...
  @usableFromInline
  internal typealias Index = Chain9CollectionIndex<A,B,C,D,E,F,G,H,I>
  ...
  func calculateFinalPosition() -> Position? {
    ...
    return Position.finalNonNil(
      ...
      self.$i.finalSubscriptableIndex
    )
  }
...
// -------------------------------------------------------------------------- //
// MARK: Chain9CollectionStorage - Reflection Support
// -------------------------------------------------------------------------- //
...
internal extension Chain9CollectionStorage {
  ...
  static var shortTypeName: String {
    get {
      return "Chain9CollectionStorage"
    }
  }
...
// -------------------------------------------------------------------------- //
// MARK: Chain9CollectionStorage - Position Advancement Support
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: Chain9CollectionStorage - Position Linearization Support
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: Chain9CollectionStorage - Position Retreat
// -------------------------------------------------------------------------- //
...
internal extension Chain9CollectionStorage {
  ...
  @inlinable
  func with(a: A) -> Chain9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return Chain9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
      d,
  ...
  @inlinable
  func with(b: B) -> Chain9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return Chain9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(c: C) -> Chain9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return Chain9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(d: D) -> Chain9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return Chain9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(e: E) -> Chain9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return Chain9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(f: F) -> Chain9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return Chain9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(g: G) -> Chain9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return Chain9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(h: H) -> Chain9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return Chain9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(i: I) -> Chain9CollectionStorage<A,B,C,D,E,F,G,H,I> {
    return Chain9CollectionStorage<A,B,C,D,E,F,G,H,I>(
      a,
      b,
      c,
...
// -------------------------------------------------------------------------- //
// MARK: Chain9CollectionStorage - Validatable
// -------------------------------------------------------------------------- //

extension Chain9CollectionStorage : Validatable {
...
extension Chain9CollectionStorage : Equatable
  ...
  internal static func ==(
    ...
    rhs: Chain9CollectionStorage<A,B,C,D,E,F,G,H,I>) -> Bool {
    guard lhs !== rhs else {
      return true
    }
    guard
...
// -------------------------------------------------------------------------- //
// MARK: Chain9CollectionStorage - Hashable
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: Chain9CollectionStorage - CustomStringConvertible
// -------------------------------------------------------------------------- //

extension Chain9CollectionStorage : CustomStringConvertible {
...
// -------------------------------------------------------------------------- //
// MARK: Chain9CollectionStorage - CustomDebugStringConvertible
// -------------------------------------------------------------------------- //

extension Chain9CollectionStorage : CustomDebugStringConvertible {
...
// -------------------------------------------------------------------------- //
// MARK: Chain9CollectionStorage - Codable
// -------------------------------------------------------------------------- //
