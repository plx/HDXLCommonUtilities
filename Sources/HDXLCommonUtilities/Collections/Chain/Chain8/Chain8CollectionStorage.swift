...
@usableFromInline
internal final class Chain8CollectionStorage<
  A:Collection,
  B:Collection,
  C:Collection,
  D:Collection,
  ...
  @usableFromInline
  internal typealias Index = Chain8CollectionIndex<A,B,C,D,E,F,G,H>
...
// -------------------------------------------------------------------------- //
// MARK: Chain8CollectionStorage - Reflection Support
// -------------------------------------------------------------------------- //
...
internal extension Chain8CollectionStorage {
  ...
  static var shortTypeName: String {
    get {
      return "Chain8CollectionStorage"
    }
  }
...
// -------------------------------------------------------------------------- //
// MARK: Chain8CollectionStorage - Position Advancement Support
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: Chain8CollectionStorage - Position Linearization Support
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: Chain8CollectionStorage - Position Retreat
// -------------------------------------------------------------------------- //
...
internal extension Chain8CollectionStorage {
  ...
  @inlinable
  func with(a: A) -> Chain8CollectionStorage<A,B,C,D,E,F,G,H> {
    return Chain8CollectionStorage<A,B,C,D,E,F,G,H>(
      a,
      b,
      c,
      d,
  ...
  @inlinable
  func with(b: B) -> Chain8CollectionStorage<A,B,C,D,E,F,G,H> {
    return Chain8CollectionStorage<A,B,C,D,E,F,G,H>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(c: C) -> Chain8CollectionStorage<A,B,C,D,E,F,G,H> {
    return Chain8CollectionStorage<A,B,C,D,E,F,G,H>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(d: D) -> Chain8CollectionStorage<A,B,C,D,E,F,G,H> {
    return Chain8CollectionStorage<A,B,C,D,E,F,G,H>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(e: E) -> Chain8CollectionStorage<A,B,C,D,E,F,G,H> {
    return Chain8CollectionStorage<A,B,C,D,E,F,G,H>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(f: F) -> Chain8CollectionStorage<A,B,C,D,E,F,G,H> {
    return Chain8CollectionStorage<A,B,C,D,E,F,G,H>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(g: G) -> Chain8CollectionStorage<A,B,C,D,E,F,G,H> {
    return Chain8CollectionStorage<A,B,C,D,E,F,G,H>(
      a,
      b,
      c,
  ...
  @inlinable
  func with(h: H) -> Chain8CollectionStorage<A,B,C,D,E,F,G,H> {
    return Chain8CollectionStorage<A,B,C,D,E,F,G,H>(
      a,
      b,
      c,
...
// -------------------------------------------------------------------------- //
// MARK: Chain8CollectionStorage - Validatable
// -------------------------------------------------------------------------- //

extension Chain8CollectionStorage : Validatable {
...
extension Chain8CollectionStorage : Equatable
  ...
  internal static func ==(
    ...
    rhs: Chain8CollectionStorage<A,B,C,D,E,F,G,H>) -> Bool {
    guard lhs !== rhs else {
      return true
    }
    guard
...
// -------------------------------------------------------------------------- //
// MARK: Chain8CollectionStorage - Hashable
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
// MARK: Chain8CollectionStorage - CustomStringConvertible
// -------------------------------------------------------------------------- //

extension Chain8CollectionStorage : CustomStringConvertible {
...
// -------------------------------------------------------------------------- //
// MARK: Chain8CollectionStorage - CustomDebugStringConvertible
// -------------------------------------------------------------------------- //

extension Chain8CollectionStorage : CustomDebugStringConvertible {
...
// -------------------------------------------------------------------------- //
// MARK: Chain8CollectionStorage - Codable
// -------------------------------------------------------------------------- //
