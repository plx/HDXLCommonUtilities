//
//  Sum9+ProductInteroperation.swift
//
...
public extension Sum9 {
  ...
  @inlinable
  func mapped<AA,BB,CC,DD,EE,FF,GG,HH,II,Mapping>(
    using mapping: Mapping) -> Sum9<AA,BB,CC,DD,EE,FF,GG,HH,II>
    where
    Mapping:AlgebraicProduct9,
    Mapping.A == (A) -> AA,
    Mapping.B == (B) -> BB,
    Mapping.C == (C) -> CC,
    Mapping.D == (D) -> DD,
