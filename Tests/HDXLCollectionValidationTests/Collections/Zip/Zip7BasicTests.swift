...
fileprivate typealias P7 = UniformInlineProduct7<Int>

class Zip7BasicTests: XCTestCase {
  ...
  func testSpecificProduct() {
    self.haltingOnFirstError() {
      ...
      let expected: [UniformInlineProduct7<Int>] = [
        P7( 0, 10, 20, 30, 40, 50, 60),
        P7( 1, 11, 21, 31, 41, 51, 61),
        P7( 2, 12, 22, 32, 42, 52, 62)
      ]
      let probe = InlineZip(
        aa,
        bb,
