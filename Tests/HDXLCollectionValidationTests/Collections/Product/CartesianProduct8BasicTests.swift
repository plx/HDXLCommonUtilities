//
//  CartesianProduct8BasicTests.swift
//
...
class CartesianProduct8BasicTests: XCTestCase {
  ...
  func testEmptyCollectionVariants() {
    ...
    let i: [Int] = [1]
    let probes = [
      CartesianProduct(e,e,e,e,e,e,e,e),
      CartesianProduct(i,e,e,e,e,e,e,e),
      CartesianProduct(e,i,e,e,e,e,e,e),
      CartesianProduct(e,e,i,e,e,e,e,e),
      CartesianProduct(e,e,e,i,e,e,e,e),
      CartesianProduct(e,e,e,e,i,e,e,e),
      CartesianProduct(e,e,e,e,e,i,e,e),
      CartesianProduct(e,e,e,e,e,e,i,e),
      CartesianProduct(e,e,e,e,e,e,e,i),
      CartesianProduct(e,i,i,i,i,i,i,i),
      CartesianProduct(i,e,i,i,i,i,i,i),
      CartesianProduct(i,i,e,i,i,i,i,i),
      CartesianProduct(i,i,i,e,i,i,i,i),
      CartesianProduct(i,i,i,i,e,i,i,i),
      CartesianProduct(i,i,i,i,i,e,i,i),
      CartesianProduct(i,i,i,i,i,i,e,i),
      CartesianProduct(i,i,i,i,i,i,i,e)
    ]
    for probe in probes {
  ...
  func testSpecificExample() {
    self.haltingOnFirstError() {
      ...
      var builtByHand: [UniformInlineProduct8<Int>] = [UniformInlineProduct8<Int>](
        repeating: UniformInlineProduct8<Int>(0,0,0,0,0,0,0,0),
        count: expectedCount
      )
      var index: Int = 0
      for a in aa {
            ...
            for d in dd {
              for e in ee {
                for f in ff {
                  for g in gg {
                    for h in hh {
                      builtByHand[index] = UniformInlineProduct8<Int>(
                        a,
                        b,
                        c,
                        d,
