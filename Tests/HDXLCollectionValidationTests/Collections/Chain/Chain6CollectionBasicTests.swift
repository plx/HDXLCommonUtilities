//
//  Chain6CollectionBasicTests.swift
//
...
class Chain6CollectionBasicTests: XCTestCase {
  ...
  func testAllButOneEmptyVariants() {
    ...
    for v in vs {
      let probes = [
        ChainCollection(e,e,e,e,e,v),
        ChainCollection(e,e,e,e,v,e),
        ChainCollection(e,e,e,v,e,e),
        ChainCollection(e,e,v,e,e,e),
        ChainCollection(e,v,e,e,e,e),
        ChainCollection(v,e,e,e,e,e)
      ]
      for probe in probes {
