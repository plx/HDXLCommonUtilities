//
//  Chain5CollectionBasicTests.swift
//
...
class Chain5CollectionBasicTests: XCTestCase {
  ...
  func testAllButOneEmptyVariants() {
    ...
    for v in vs {
      let probes = [
        ChainCollection(e,e,e,e,v),
        ChainCollection(e,e,e,v,e),
        ChainCollection(e,e,v,e,e),
        ChainCollection(e,v,e,e,e),
        ChainCollection(v,e,e,e,e)
      ]
      for probe in probes {
