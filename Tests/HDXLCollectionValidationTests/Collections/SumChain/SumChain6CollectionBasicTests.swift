//
//  SumChain6CollectionBasicTests.swift
//
...
class SumChain6CollectionBasicTests: XCTestCase {
  ...
  func testAllButOneEmptyVariants() {
    ...
    for v in vs {
      let probes = [
        SumChainCollection(e,e,e,e,e,v),
        SumChainCollection(e,e,e,e,v,e),
        SumChainCollection(e,e,e,v,e,e),
        SumChainCollection(e,e,v,e,e,e),
        SumChainCollection(e,v,e,e,e,e),
        SumChainCollection(v,e,e,e,e,e)
      ]
      for probe in probes {
