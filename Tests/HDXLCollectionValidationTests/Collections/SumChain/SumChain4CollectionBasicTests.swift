//
//  SumChain4CollectionBasicTests.swift
//
...
class SumChain4CollectionBasicTests: XCTestCase {
  ...
  func testAllButOneEmptyVariants() {
    ...
    for v in vs {
      let probes = [
        SumChainCollection(e,e,e,v),
        SumChainCollection(e,e,v,e),
        SumChainCollection(e,v,e,e),
        SumChainCollection(v,e,e,e)
      ]
      for probe in probes {
