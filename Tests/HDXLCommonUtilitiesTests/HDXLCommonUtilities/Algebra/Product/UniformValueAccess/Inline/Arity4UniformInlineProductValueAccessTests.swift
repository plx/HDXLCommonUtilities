//
//  Arity4UniformInlineProductValueAccessTests.swift
//
...
class Arity4UniformInlineProductValueAccessTests: XCTestCase {
  
  typealias P = UniformInlineProduct4<Int>
  
  let arity: Int = P.arity
  lazy var indices: Range<Int> = 0..<self.arity
  let positions: [P.ArityPosition] = P.ArityPosition.allCases
  
  let standardProbe: P = P(0,1,2,3)
