//
//  Arity6UniformInlineProductValueAccessTests.swift
//
...
class Arity6UniformInlineProductValueAccessTests: XCTestCase {
  
  typealias P = UniformInlineProduct6<Int>
  
  let arity: Int = P.arity
  lazy var indices: Range<Int> = 0..<self.arity
  let positions: [P.ArityPosition] = P.ArityPosition.allCases
  
  let standardProbe: P = P(0,1,2,3,4,5)
