//
//  Arity3UniformInlineProductValueAccessTests.swift
//
...
class Arity3UniformInlineProductValueAccessTests: XCTestCase {
  
  typealias P = UniformInlineProduct3<Int>
  
  let arity: Int = P.arity
  lazy var indices: Range<Int> = 0..<self.arity
  let positions: [P.ArityPosition] = P.ArityPosition.allCases
  
  let standardProbe: P = P(0,1,2)
