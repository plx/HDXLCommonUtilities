//
//  Arity5UniformInlineProductValueAccessTests.swift
//
...
class Arity5UniformInlineProductValueAccessTests: XCTestCase {
  
  typealias P = UniformInlineProduct5<Int>
  
  let arity: Int = P.arity
  lazy var indices: Range<Int> = 0..<self.arity
  let positions: [P.ArityPosition] = P.ArityPosition.allCases
  
  let standardProbe: P = P(0,1,2,3,4)
