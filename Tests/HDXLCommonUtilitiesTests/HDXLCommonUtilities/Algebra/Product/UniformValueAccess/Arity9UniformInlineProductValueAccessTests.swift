//
//  Arity9UniformInlineProductValueAccessTests.swift
//
...
class Arity9UniformInlineProductValueAccessTests: XCTestCase {
  
  typealias P = UniformInlineProduct9<Int>
  
  let arity: Int = P.arity
  lazy var indices: Range<Int> = 0..<self.arity
  let positions: [P.ArityPosition] = P.ArityPosition.allCases
  
  let standardProbe: P = P(0,1,2,3,4,5,6,7,8)
